...
var _CheckBoxOutlineBlank = require('material-ui/svg-icons/toggle/CheckBoxOutlineBlank');

var _CheckBoxOutlineBlank2 = _interopRequireDefault(_CheckBoxOutlineBlank);

var _ArrowDropDown = require('material-ui/svg-icons/ArrowDropDown');
  ...
  _createClass(SelectField, [{
    ...
    value: function render() {
      ...
      var menuItemBuilder = function menuItemBuilder(nodes, child, index) {
        ...
        return [].concat(_toConsumableArray(nodes), [_react2.default.createElement(_List.ListItem, {
          key: ++index,
          tabIndex: index,
      ...
      var menuItems = !disabled && fixedChildren.length && this.state.isOpen && fixedChildren.reduce(function (nodes, child, index) {
        ...
        var menuGroup = _react2.default.createElement(_List.ListItem, {
          disabled: true,
          key: nextIndex,
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            menuItems.length ? _react2.default.createElement(
              ...
              menuItems
            ) : _react2.default.createElement(_List.ListItem, { primaryText: noMatchFound, style: { cursor: 'default', padding: '10px 16px' }, disabled: true })
          ),
